...
namespace Data {
    ...
    // inline std::string lockPickSteel{"Interface/Lockpicking/Euda/LockPickSteel01.nif"sv};
    // inline std::string lockPickDwarven{"Interface/Lockpicking/Euda/LockPickDwarven01.nif"sv};
